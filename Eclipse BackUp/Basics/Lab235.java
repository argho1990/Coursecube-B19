 ...
 * ===>Only one copy of memory will be allocated for static variables for multiple 
 *     variables and single copy of memory will be accessed by all the object. 
 *     Static variable is related to class so when you change data of static variable 
 *     the modified data will be accessed by the objects
 *     You can access static variable by using the reference variable which contains 
 *     null. 
 *         
 *     
 *     [change class name to Hello9]
 */
...
class Hello7{
 ...
 static {
	...
	Hello7 h = null;
	//System.out.println(h.b);/* Changes to Hello.b */
