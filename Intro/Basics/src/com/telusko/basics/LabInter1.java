...
interface A{  //interface declaring a show method
    ...
    void show(); //by default method is public abstract ==> public abstract void show();
 // void display1();// ==>must be implemented in class C
...
class B implements A,C{ // class which is defining a show method.
	...
	public void shave() {
	System.out.println("shave properly");	
	}
}
